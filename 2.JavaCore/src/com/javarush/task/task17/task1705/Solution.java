...
public class Solution {
    ...
    public static class Garden {
        ...
        public synchronized void addFruit(int index, String note) {
            fruits.add(index, note);
        }
        ...
        public synchronized void addVegetable(int index, String note) {
            vegetables.add(index, note);
        }
